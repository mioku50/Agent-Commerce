...
async function main() {
  ...
  try {
    ...
    // 4. Switch browser wallet to Agent Wallet and verify wallet activation binding
    console.log("[byoa-two-wallet-e2e] 4. Switching browser wallet to Agent Wallet for binding...");
