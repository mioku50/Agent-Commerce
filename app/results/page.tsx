...
export const metadata = {
  ...
  description:
    "Browse completed reports generated by Arc Agent Commerce.",
};
    ...
    <main className="min-h-screen bg-background">
      <section className="border-b bg-secondary/20">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-12 sm:px-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <Badge className="mb-4">Generated Reports</Badge>
            <h1 className="text-4xl font-bold tracking-normal sm:text-5xl">Reports</h1>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pt-8 sm:px-6">
        <Card className="rounded-lg">
          <CardContent className="p-5">
            ...
            <p className="mt-2 font-mono text-2xl font-semibold">{reports.length.toString()}</p>
          </CardContent>
        </Card>
      </section>
