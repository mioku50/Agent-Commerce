...
Investigate only the repository areas necessary to let the Codex head write a complete issue-spec.
...
- Head: Codex via ChatGPT subscription and ~/.codex/config.toml
- Worker model: Gemini 3.1 Pro (High)
- Gemini permission mode: --dangerously-skip-permissions
- Final acceptance authority: Codex
